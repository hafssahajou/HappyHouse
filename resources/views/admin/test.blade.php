                        ...
                        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div class="overflow-hidden border  md:rounded-lg">
                                <table class="min-w-full divide-y divide-teal-700">
                                    ...
                                    <tbody class="bg-white divide-y divide-black " id="users-container">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    ...
                                                    <div class="text-sm text-yellow-500 bg-yellow-500/20 w-fit px-4 py-1 rounded-2xl">admin</div>
                                              
                                                    <div class="text-sm text-yellow-500 bg-yellow-500/20 w-fit px-4 py-1 rounded-2xl">organiser</div>
                                                
                                                    <div class="text-sm text-yellow-500 bg-yellow-500/20 w-fit px-4 py-1 rounded-2xl">Client</div>
